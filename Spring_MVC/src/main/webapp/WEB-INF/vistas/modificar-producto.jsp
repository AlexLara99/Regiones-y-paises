    ...
    <body> 
        ...
        <section class="container"> 
            <form:form  method="POST" modelAttribute="producto" class="form-horizontal"> 
                <fieldset> 
                    <legend>Modificar el producto ${producto.nombre }</legend> 
                    ...
                    <div class="form-group"> 
                        ...
                        <div class="col-lg-10"> 
                            <form:input id="idProducto" path="idProducto" type="text" class="form:input-large" disabled="true"/> 
                    ...
                    <div class="form-group"> 
                        <label class="control-label col-lg-2" 
                               for="descripcion"><spring:message code="producto.desc"/></label> 
                        <div class="col-lg-10"> 
                    ...
                    <div class="form-group"> 
                        <label class="control-label col-lg-2 col-lg-2" 
                               ...
                               <form:errors path="precioUnitario" cssClass="text-danger"/>
                        <div class="col-lg-10"> 
